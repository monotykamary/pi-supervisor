...
describe("parseDecision", () => {
  ...
  it("extracts JSON from curly braces when no code block", () => {
    const text = 'Some text before { "action": "steer", "message": "Help", "reasoning": "Test", "confidence": 0.7 } some after';
...
describe("extractThinking", () => {
  ...
  it("extracts reasoning that appears later in the JSON", () => {
    const text = '{ "action": "steer", "confidence": 0.9, "reasoning": "Late reasoning", "message": "Hi" }';
